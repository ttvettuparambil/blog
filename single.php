...
<!-- Path to path.php not included for now(depreciation warning) -->
<?php include('path.php');?>
<?php include(ROOT_PATH . '/app/controllers/posts.php');
// getting content corresponding to user id
if(isset($_GET['id']))
{
$post=selectOne('posts',['id'=>$_GET['id']]);
// dd($post);
}
// filtering according to topics
$topics=selectAll('topics');
// getting popular posts from database
...
<!-- including header from header.php -->
<?php include("app/includes/header.php"); ?>
  ...
  <!-- footer -->
  <!-- ROOT_PATH is the path to the root directory of the application -->
